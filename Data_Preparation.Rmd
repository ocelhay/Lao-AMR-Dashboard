...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path('./data/', paste0("Data_Preparation_AMR_", format(Sys.time(), '%Y-%m-%d_%H%M'), ".html"))) })
...
time_start <- format(Sys.time(), '%Y-%m-%d_%H%M')
```
...
getwd()
amr <- read_excel("./data/LIMS_AMR_2018-10-03.xlsx", guess_max = 21474836)
...
amr$location[amr$location == "Military Hospital (MIL)"] <- "Military Hospital Vientiane"
```
