...
output$organism_isolates_any <- renderText({
  req(data_available())
...
output$organism_sir_plot_any <- renderPlot({
  req(data_available())
...
output$organism_sir_table_any <- renderDT({
  req(data_available())
...
output$organism_isolates_year_any <- renderPlot({
  req(data_available())
